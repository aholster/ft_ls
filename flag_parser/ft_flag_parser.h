...
/*   Updated: 2019/10/10 03:25:51 by aholster      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
typedef void	(*flg_handler)(t_flags *const restrict)
...
** 	// F = 1LU << 4, postfix filetypes based on type (/ for dir, *for executable, @ symlink, = socket, % whiteout, | fifo)
** 	// G = 1LU << 5, Colourized output!
** 	// H = 1LU << 6, symbolic links on command line are followed? (intresting, possibly easy) (assumes -F, -d, -l are all off)
...
** 	r = 1LU << 32, reverse order of sorting, lexographical order or oldest entires first (largest last if also size)
